...
d3.select('body').style('font-family', 'Times New Roman')
...
const barChart = (data, probe) => {
    ...
    lineArea.selectAll('line')
        ...
        .attr('stroke', d => chrScale(d.chr)) //设置线条颜色以比对的基因组为准
